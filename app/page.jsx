          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <Button size="lg" className="uppercase flex items-center gap-2">
              ...
              <div className="mb-8 xl:mb-0">
                ...
                iconStyles="w-9 h-9 bg-amber-400 rounded-full flex justify-center items-center text-black text-base hover:bg-yellow-200 hover:text-black hover:transition-all duration-500"/>
              </div>
            </div>
          </div>
          {/* photo */} 
